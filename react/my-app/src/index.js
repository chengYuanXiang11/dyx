...
function EventAPI() {
  ...
  const [dis, setdis] = useState({ color: 'red', fontSize: '20px', transition: "all 2s",a:{
    "c":'1'
  }})
  ...
  //   const list = { ...dis }
  //   Reflect.ownKeys(list).forEach((value)=>{
  //     console.log(value,list[value])
  //     console.log(list[value] === dis[value])
  ...
  return (
    ...
    <RouterApp></RouterApp>
      ...
      <input defaultValue={dis.color} onChange={setChang} onClick={changeDis} />
