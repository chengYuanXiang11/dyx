    ...
    <div v-loading="loading">
      <div class="steps-box">
        <div class="step-title">
          ...
          <el-tag :type="ruleForm.repair_status == 1 ? 'warning' : 'success'">{{
            ruleForm.repair_status == 1
              ? "待分配"
              : ruleForm.repair_status == 2
              ? "已分配"
              : "已完成"
          }}</el-tag>
          ...
          <el-col :span="16">
            <el-descriptions :column="3" title="报修信息">
              ...
              <el-descriptions-item
                ...
                >{{ ruleForm.create_datetime }}</el-descriptions-item
              >
              <el-descriptions-item
                label="预约时间"
                v-if="pageType == 'wancheng'"
          ...
          <el-col :span="12" v-if="pageType == 'wancheng'">
            ...
            >
              <el-form-item label="维修人" prop="repairer">
                <el-input v-model="ruleForm.repairer"></el-input>
              </el-form-item>
              <el-form-item label="联系电话" prop="repair_phone">
                <el-input v-model="ruleForm.repair_phone"></el-input>
              </el-form-item>
              <el-form-item label="故障原因" prop="result">
                <el-input v-model="ruleForm.result"></el-input>
              </el-form-item>
              <el-form-item label="维修前">
                <UploadImg v-model="before_repair" :limit="3"></UploadImg>
              </el-form-item>
              <el-form-item label="维修后">
                <UploadImg v-model="after_repair" :limit="3"></UploadImg>
              </el-form-item>
              <el-form-item>
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          arrangePersonnel(self.ruleForm, self.id)
            .then((response) => {
              self.ruleForm = response.data;
              self.closePage();
            })
