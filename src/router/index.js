  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: (resolve) =>
          require([
            "@/views/market/merchantsMgmt/chinaMerchants/merchantManagement/index",
          ], resolve),
      ...
      },
      {
        ...
        component: (resolve) =>
          require([
            "@/views/market/merchantsMgmt/chinaMerchants/leaseManage/index",
          ], resolve),
        name: "leaseManage",
        meta: {
          title: "租赁管理",
      ...
      },
      {
        ...
        component: (resolve) =>
          require([
            "@/views/market/merchantsMgmt/chinaMerchants/leaseManage/add",
          ], resolve),
        name: "leaseManageAdd",
        meta: {
          title: "新建",
      ...
      },
      {
        ...
        component: (resolve) =>
          require([
            "@/views/market/merchantsMgmt/chinaMerchants/leaseManage/view",
          ], resolve),
      ...
      },
      {
        ...
        component: (resolve) =>
          require([
            "@/views/market/merchantsMgmt/chinaMerchants/leaseManage/fee",
          ], resolve),
        name: "leaseManageFee",
        meta: {
          title: "费用管理",
      ...
      },
      {
        ...
        hidden: true,
        component: (resolve) =>
          require(["@/views/market/merchantsMgmt/enter/list"], resolve),
        name: "recordList",
        meta: {
          title: "查看",
        },
      ...
      },
      {
        ...
        hidden: true,
        component: (resolve) =>
          require(["@/views/lot/waterpower/waterRecords/operation"], resolve),
        name: "waterPage",
        meta: {
          title: "查看",
        },
      },
      {
        ...
        component: (resolve) =>
          require([
            "@/views/lot/electricPower/electricityRecord/operation",
          ], resolve),
        name: "electricPower",
        meta: {
          title: "查看",
      ...
      },
      {
        ...
        hidden: true,
        component: (resolve) =>
          require(["@/views/financial/income/water/waterAdd"], resolve),
        name: "waterAdd",
        beforeEnter: (to, from, next) => {
      ...
      },
      {
        ...
        component: (resolve) =>
          require([
            "@/views/financial/income/electricity/electricityAdd",
          ], resolve),
        name: "electricityAdd",
        beforeEnter: (to, from, next) => {
          to.meta.title = to.query.type == "add" ? "新建" : "编辑";
      ...
      },
      {
        ...
        hidden: true,
        component: (resolve) =>
          require(["@/views/financial/income/rent/addEdit"], resolve),
        name: "addEdit",
        beforeEnter: (to, from, next) => {
          to.meta.title = to.query.type == "add" ? "新建" : "编辑";
          next();
      ...
      {
        path: "safety",
        component: () => import("@/views/system/safety"),
        name: "safety",
        meta: {
          title: "安全认证",
        },
