    ...
    <div class="upload-main">
        ...
        <el-row v-if="list">
            <el-col v-for="(item, index) in fileList" :key="index">
                <el-col class="file_warp"  :class="sime?'':'addItem'">
                    ...
                    <el-col :span="8" class="file_handler"    v-if="Exhibition">
        ...
        >
            ...
            <el-button slot="trigger" :class="sime?'':'addItem'" v-if="list">添加附件</el-button>
        </el-upload>
    </div>
</template>
<script>
