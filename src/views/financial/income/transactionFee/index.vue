<template>
		...
		>
			...
			<el-table class="yg-table" :data="tableData" v-loading="loading">
				...
				<el-table-column label="规则类型" prop="rulesType"></el-table-column>
				<el-table-column label="费用类型" prop="dealType"></el-table-column>
				...
				<el-table-column label="操作">
					<template slot-scope="scope">
						...
						<el-button type="text" v-if="scope.row.inOutFeeName != '其他'" @click="del(scope.row.id)">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
			<Drawer
