<template>
  ...
  >
    <el-table v-loading="loading" :data="tableData" border height="100%">
      <el-table-column label="故障类型" prop="code" show-overflow-tooltip />
      <el-table-column label="设备编码" prop="name" show-overflow-tooltip>
      </el-table-column>
      />
      <el-table-column label="设备名称" prop="type" show-overflow-tooltip>
      </el-table-column>
      <el-table-column
        label="故障时间"
        prop="failureTime"
