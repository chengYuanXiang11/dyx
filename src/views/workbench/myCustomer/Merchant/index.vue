...
import {
  ...
  updateOfficeAddress,
  delOfficeAddress,
} from "@/request/api/workbench/myCustomer/merchant.js"
export default {
  props: {
    searchParams: {
      type: Object,
  ...
  data() {
    return {
      ...
      paging: {
        ...
        pageNum: 1,
        pageSize: 20,
        storeName: this.searchParams.storeName,
        status: this.searchParams.status,
        saleCategory: this.searchParams.saleCategory,
        customerType: this.searchParams.customerType,
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      // this.$forceUpdate()
      this.$emit("update:searchParams", this.paging)
      getList(this.paging)
        .then((response) => {
