    ...
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label>
        <el-descriptions title="租赁" :column="3">
          ...
          <el-descriptions-item label="名称">{{ form.merchantName }}</el-descriptions-item>
      ...
      <el-form-item
        label="合同信息"
        v-if="$route.query.type == 'enterView' || $route.query.type == 'view'"
      >
      ...
      <el-form-item
        label="合同信息"
        v-if="$route.query.type == 'enterUpload' || $route.query.type == 'contract'"
      >
