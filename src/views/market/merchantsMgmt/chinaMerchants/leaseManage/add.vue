      ...
      <div class="lease" v-for="(formItem,formIndex) in form" :key="formIndex">
        ...
        <div v-if="tagsActive == formIndex">
          ...
          <el-form-item label="支付方案" :rules="rules">
              ...
              <el-form-item label label-width="0">
                <el-radio-group v-model="formItem.radioCustom">
                  <el-radio
                    ...
                    :key="indexPay"
                  >每{{ itemPay.period }}{{ itemPay.time | timeFilter }}{{ itemPay.money }}元</el-radio>
                </el-radio-group>
              </el-form-item>
              <el-form-item label=" " label-width="0">
            ...
            <!-- 无数据情况 -->
            <div class="customized" v-if="isShow == 2">
              <span class="zj-radio">
                <span class="text">每</span>
...
export default {
  ...
  computed: {
    ...
    getRadioCustom() {
      ...
      if (this.form[this.tagsActive].radioCustom === 999999) {
        this.form[this.tagsActive].paymentScheme = this.form[this.tagsActive].paymentSchemeCustom
      } else {
        this.form[this.tagsActive].paymentScheme = this.arrayList[this.tagsActive].paymentList[[this.form[this.tagsActive].radioCustom]]
      }
      return this.form[this.tagsActive].radioCustom
        ...
        if (valid) {
          ...
          _this.$confirm("确认提交吗?", '提示', {
            ...
            _this.form.map(item => {
              ...
              delete item.paymentSchemeCustom
            })
