<template>
  ...
  >
    <template slot="action-bar">
      <div class="box">
        <el-button type="primary" @click="switchOff">一键拉闸</el-button>
        <el-button type="primary" @click="switchOff">一键合闸</el-button>
        <el-button type="primary" @click="switchOff">一键保电</el-button>
        <el-button type="primary"  @click="switchOff">一键接触保电</el-button>
      </div>
    </template>
    <el-table
      v-loading="loading"
  ...
  methods: {
    ...
    getList() {
      ...
      axios.get('http://localhost:8081/a.json').then(res=>{
        this.tableData =  res.splice(0,this.search.pageNum*(this.search.pageSize-9))
      })
    },
    // 选中数据变化
    changeData(e){
