        ...
        >
            <el-form :model="form" :rules="rules" ref="form">
                <el-form-item label="楼层序号" prop="order_num">
                    <el-input v-model="form.order_num" placeholder="请输入楼层序号"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        mapconfirmForm() {
            ...
            res.center = this.COI;
            res.is_map = 1;
            if (res.map.length == 0 && res.map_resource == '') {
                this.$message({
                    message: '图片或资源至少上传一个！',
                    type: 'warning'
                });
        ...
        getList() {
            getFloorList(this.id, this.queryFormat(this.queryParams, this.search))
                .then((resp) => {
