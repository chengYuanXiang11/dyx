const qs = require("qs");
import { loadLoginStatus, saveLoginStatus, removeLoginStatus } from "./cookie";

const CONFIG_STORAGE = {
  tc: "WX_OPENID", // 微信openId
