<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="设备编码" prop="ticketcode" />
      <el-table-column label="设备名称" prop="repair_type" />
      <el-table-column label="设备类型" prop="address" />
      <el-table-column label="故障提醒数量" prop="addressOne" />
