<template>
  <div class="app-container">
    <el-table v-loading="loading" :data="tableData" class="yg-table">
      <el-table-column label="客户姓名" prop="client_name" />
      <el-table-column label="联系电话" prop="connect_phone" />
      <el-table-column label="客户类型" prop="client_type" :formatter="formatCustomerType" />
      <el-table-column label="拟经营品种" prop="client_business" :formatter="formatSaleCategory" />
      <el-table-column label="客户分类" prop="client_classfy" :formatter="formatCustomerClassify"></el-table-column>
      <el-table-column label="客户来源" prop="client_origin" :formatter="formatCustomerSource"></el-table-column>
