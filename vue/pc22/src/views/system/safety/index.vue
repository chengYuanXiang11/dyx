    ...
    >
      ...
      >
        <el-form-item
          :label="stateLabel"
          prop="homepagelogo"
          v-if="configKey !== 'resetpwd' && configKey !== 'appmemorycache'"
        >
          <el-switch
            v-model="form.state"
            active-color="#048790"
        ...
        <!-- 商品检查 -->
        <div v-if="configKey === 'appmemorycache'">
          <DuplicateForm
            :form="form"
            labelWidth="120px"
            ref="formRef"
          ...
          <el-form-item label="调高核实">
            <el-switch
              v-model="form.heighten_verify.status"
              active-color="#048790"
              inactive-color="#ff4949"
              active-value="1"
              inactive-value="2"
            ...
            <DuplicateForm
              ref="heightenRef"
              :form="form.heighten_verify"
              v-if="form.heighten_verify.status === '1'"
            ></DuplicateForm>
          </el-form-item>
          <el-form-item label="调低核实">
            <el-switch
              v-model="form.turn_down_verify.status"
              active-color="#048790"
              inactive-color="#ff4949"
              active-value="1"
              inactive-value="2"
            ...
            <DuplicateForm
              ref="turnDownRef"
              :form="form.turn_down_verify"
              v-if="form.turn_down_verify.status === '1'"
            ></DuplicateForm>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
    ...
    confirmForm() {
      // 编辑商品检查时候需要验证子组件是否通过
      if (this.configKey === "appmemorycache") {
        let arr = [];
