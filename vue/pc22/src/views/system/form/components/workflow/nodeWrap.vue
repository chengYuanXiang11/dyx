            ...
            <div class="drawer-main">
                <div class="drawer-form">
                    ...
                    >
                        ...
                        <!-- 交通工具 -->
                        <el-form-item
                            v-if="conditionForm.type == 'businesstripVehicle'"
                            prop="businesstripVehicle"
                        >
                            <div class="rated-conditions">
                                <el-select v-model="conditionForm.businesstripVehicle">
                                    <el-option
                                        :value="ctem.value"
                                        :label="ctem.label"
                                        v-for="(ctem, idx) in conditionOptions"
                                        :key="idx"
                                    ></el-option>
                                </el-select>
                            </div>
...
export default {
    ...
    computed: {
        ...
        conditionOptions(){
            return this.form_fields.find(item => item.field == this.conditionForm.type).options
        }
    },
    watch: {
        value(newVal) {
