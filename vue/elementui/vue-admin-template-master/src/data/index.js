...
export const menuList = [
    {
        id: 1, name: "系统管理", url: "/systemManage", menuRoute: "#", resType: "menu", parentId: -1, children: [
            { id: 2, name: "机构管理", url: "/org", menuRoute: "system_manage/org/index", resType: "org", parentId: 1, children: [] },
            { id: 3, name: "角色管理", url: "/role", menuRoute: "system_manage/role/index", resType: "role", parentId: 1, children: [] }
