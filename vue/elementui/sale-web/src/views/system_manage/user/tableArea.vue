<template>
  <div class="listTemplateTable">
    <!-- default-expand-all -->
     <el-tabs v-model="userState.activeName">
    <el-tab-pane label="用户管理" name="1"></el-tab-pane>
    <el-tab-pane label="经销商管理" name="2"></el-tab-pane>
  </el-tabs>
    <el-table
...
export default {
  ...
  computed:{
    ...
    activeName(){ return this.userState.activeName}
  },
  watch:{
    activeName(newValue, oldValue){ this.$emit("getTableList", 1); }
  },
  methods: {
